...
| Annotation authoring and inline note popovers | [docs/plans/annotation_authoring_inline_note_plan.md](./annotation_authoring_inline_note_plan.md) | active | [docs/plans/mvp_reader_math_notes_plan.md](./mvp_reader_math_notes_plan.md), [docs/plans/robust_mathjax_renderer_plan.md](./robust_mathjax_renderer_plan.md) | Plans the first writable-reader slice: edit and create supported note annotations, save them back to standard PDF annotations, and move note interaction from the detached inspector to an annotation-anchored MathPDF popover. |
