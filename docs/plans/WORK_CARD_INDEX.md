...
| Preview-replacement reader overhaul | [docs/plans/preview_replacement_overhaul.md](./preview_replacement_overhaul.md) | active | [annotation prototype](../history/annotation_authoring_inline_note_plan.md), [MathJax renderer](../history/robust_mathjax_renderer_plan.md) | Implementation, signed production-host tests, direct Preview popup expansion, independent raw parsing, and static visual review pass are recorded. The latest focused interaction verdict is NO-PASS for permanent note/macro dirty-state truth; an exact-window correction builds signed and awaits visible retest. |
