...
| Preview-replacement reader overhaul | [docs/plans/preview_replacement_overhaul.md](./preview_replacement_overhaul.md) | active | [annotation prototype](../history/annotation_authoring_inline_note_plan.md), [MathJax renderer](../history/robust_mathjax_renderer_plan.md) | Implementation, signed production-host tests, direct Preview popup expansion, independent raw parsing, and independent static visual review pass. The explicitly required independent Computer Use interaction verdict remains unverified because the review channel stalls before returning visible state. |
